          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              <button 
                ...
                className="hidden md:flex items-center gap-2 text-sm font-semibold text-[#111111] bg-[#F4C84A] px-4 py-2 rounded-xl shadow-sm hover:scale-105 transition-all border border-[#F4C84A]"
              >
                    ...
                    <div className="flex flex-col sm:flex-row gap-5">
                      ...
                      <div className="mt-5 pt-4 border-t border-slate-100 flex items-center justify-between gap-3">
                        <button 
                          ...
                          className="inline-flex items-center gap-1.5 text-sm font-bold text-white bg-emerald-600 hover:bg-emerald-700 px-5 py-2.5 rounded-lg shadow-sm transition-colors border border-emerald-600"
                        >
                          <Activity className="w-4 h-4" /> Fill through Agent
                        </button>
